...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#ddd', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, fontSize: 14, marginBottom: 12 },
  ...
  resultCount: { fontSize: 12, color: '#888', marginBottom: 8 },
  ...
  cardDate: { fontSize: 12, color: '#888', marginTop: 4, marginBottom: 4 },
